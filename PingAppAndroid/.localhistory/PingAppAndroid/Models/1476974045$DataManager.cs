...
namespace PingAppAndroid.Models
{
    static public class DataManager
    {
        ...
        static ISharedPreferencesEditor editor = mPrefs.Edit();
        ...
        internal static async void GetAllFriendsAsync()
        {
            ...
            client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", mPrefs.GetString("token", ""));
